...
class ClimaoroConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_add_room(self, user_input: dict[str, Any] | None = None):
        ...
        schema = {
            ...
            vol.Optional(CONF_TEMP_SALVATA, default="", description={"suggested_value": ""}): _entity_selector(["number"]),
            vol.Optional(CONF_MODALITA, default="", description={"suggested_value": ""}): _entity_selector(["switch"]),
            vol.Optional(CONF_RINNOVO, default="", description={"suggested_value": ""}): _entity_selector(["button"]),
